    ...
    protected void onResume() {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Updated Succeessfully", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Deleted Succeessfully", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myDB.readInfo(txtName.getText().toString(), txtPassword.getText().toString()))
                    Toast.makeText(MainActivity.this, "User name and password does exist", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(MainActivity.this, "User name  and password does not exist", Toast.LENGTH_LONG).show();
            }
        });
    }
    }
